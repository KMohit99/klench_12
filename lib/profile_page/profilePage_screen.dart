...
class _ProfilePageScreenState extends State<ProfilePageScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() => (_profile_page_controller.isuserinfoLoading.value == true
          ? Center(
              child: Material(
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: Container(
                                    ...
                                    child: (_profile_page_controller
                                                .userInfoModel!.data![0].image ==
                                            null
                                        ? Image.asset(
                                        ...
                                        : Image.network(
                                            'http://foxyserver.com/klench/images/${_profile_page_controller.userInfoModel!.data![0].image}',
                                            fit: BoxFit.fill,
                                            height: 100,
                                            width: 100,
                                          )),
                          ...
                          children: [
                            Container(
                              child: CommonTextFormField(
                                controller:
                                    _profile_page_controller.nameController,
                            ...
                            Container(
                              child: CommonTextFormField(
                                labelText: 'Gender',
                                controller:
                                    _profile_page_controller.genderController,
                                tap: () {
